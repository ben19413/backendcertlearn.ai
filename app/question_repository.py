...
class QuestionRepository:
    ...
    def add_question(self, test_id: str, exam_type: str, topic: str, topic_number: int, batch_number: int, question: str, answer_1: str, answer_2: str, answer_3: str, answer_4: str, solution: int):
